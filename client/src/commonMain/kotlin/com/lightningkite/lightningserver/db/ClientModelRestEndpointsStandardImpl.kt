...
open class ClientModelRestEndpointsStandardImpl<T: HasId<ID>, ID: Comparable<ID>>(
    val fetchImplementation: suspend (url: String, method: HttpMethod, jsonBody: String?) -> RequestResponse,
    ...
    ).readJson(ListSerializer(PartialSerializer(serializer)))
    ...
    ).readJson(EntryChange.serializer(serializer))
    ...
    ).readJson(MapSerializer(String.serializer(), Int.serializer()))
    ...
    ).readJson(Double.serializer().nullable)
    ...
    ).readJson(MapSerializer(String.serializer(), Double.serializer().nullable))
...
open class ClientModelRestEndpointsPlusWsStandardImpl<T: HasId<ID>, ID: Comparable<ID>>(
    fetchImplementation: suspend (url: String, method: HttpMethod, body: String?) -> RequestResponse,
