...
public interface ProofComponent {
     ...
     */
    public fun render(to: ViewWriter, primaryIdentifier: UserIdentification?, checks: ProofsCheckResult<*>?, onResult: (Proof?) -> Unit): Unit {
     ...
     * @return The rendered view
     */
    public fun render(to: ViewWriter, primaryIdentifier: UserIdentification?, option: ProofOption, onResult: (Proof?) -> Unit): Unit = TODO()
}
